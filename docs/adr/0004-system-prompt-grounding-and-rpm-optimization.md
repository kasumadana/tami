...
- **Latensi Minimal:** Mengeliminasi *network round-trip* perantara sehingga respon percakapan Sokratik dapat mulai di-stream secara instan ($< 1.5$ detik).
