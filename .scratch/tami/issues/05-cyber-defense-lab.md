...
- [ ] Simulator 1 (Phishing Inspector): Antarmuka simulasi email masuk di mana siswa dapat mengklik dan mengaudit bagian mencurigakan (header pengirim, tautan tersembunyi, kalimat urgensi).
- [ ] Simulator 2 (Password Auditor): Alat interaktif penghitung entropi dan estimasi waktu retas kata sandi dengan feedback visual kombinasi frasa.
