# 04 — Structured Curriculum Modules (/learn) & Family Guide (/guide)

**What to build:** Halaman kurikulum terstruktur di `/learn` yang memuat 4 topik literasi siber esensial (Keamanan Sandi, Privasi Data, Phishing, dan Cyberbullying) dengan ringkasan poin kunci dan studi kasus interaktif, serta rute publik `/guide` berisi panduan diskusi keluarga dan lembar ajar kelas untuk guru dan orang tua.
