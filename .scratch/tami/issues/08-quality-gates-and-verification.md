...
- [x] Lulus verifikasi TypeScript tanpa error: `pnpm tsc --noEmit`.
- [x] Lulus audit ketat i18n AST dengan 0 pelanggaran string hardcoded: `pnpm tsx scripts/audit-i18n.ts`.
- [x] Lulus build produksi Next.js 16: `pnpm build`.
- [x] Memenuhi skor Google Lighthouse $\ge 95$ untuk Kategori Aksesibilitas dan Performa pada perangkat mobile.
- [x] Memenuhi target WCAG AA (rasio kontras teks $\ge 4.5:1$, target sentuh $\ge 44\text{px}$, dukungan `prefers-reduced-motion`).
